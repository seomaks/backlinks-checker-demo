...
const initialState = {
  ...
  links: ['https://betterthisworld.com/uncategorized/where-athletes-get-their-inspiration/',
    'https://www.smallbusinesscoach.org/how-athletes-today-run-a-sports-business-on-the-internet/'] as EntitiesType,
